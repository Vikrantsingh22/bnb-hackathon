    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-white-400 to-white-300 rounded-xl flex items-center justify-center shadow-[0_4px_15px_rgba(255,235,59,0.3)]">
            <img src="logo.png" alt="BNBRAWL Logo" />
          </div>
          <div>
            ...
            <p className="text-gray-300 text-xs sm:text-sm font-rajdhani-regular">
